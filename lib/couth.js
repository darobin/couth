...
,   prepareValidation:  function () {
        if (Object.keys(this.types).length) {
            ...
            var validation = function (newDoc, oldDoc, user) {
                ...
                ,   JSONValidation = require("libs/json-validation").JSONValidation
                ;
                ...
                // manage permissions
                var perms = this.types[$type].permissions
...
,   addLib: function (libName, libPath) {
        if (!this.design.libs) this.design.libs = {};
        if (this.design.libs[libName]) return;
        this.design.libs[libName] = loadContent(libPath).toString("utf8");
    }
};
