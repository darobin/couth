...
,   buildResourceAPI:   function () {
        ...
        // XXX refactor attaching files
        var path = "/couth/js/couth-resource-api.js";
        this.addRewrite(path, path);
        this.addAttachment( path.replace(/^\//, ""), new Buffer(js), "text/javascript");
        // add the client too
        var client = "/couth/js/couth-client.js";
        this.addRewrite(client, client);
        this.addAttachment(client.replace(/^\//, ""), pth.join(__dirname, "client/couth-client.js"), "text/javascript");
        // and angular
        var ng = "/couth/js/angular.min.js";
        this.addRewrite(ng, ng);
        this.addAttachment(ng.replace(/^\//, ""), pth.join(__dirname, "../vendor/angular.min.js"), "text/javascript");
    }
};
