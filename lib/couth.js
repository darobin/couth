...
,   buildResourceAPI:   function () {
        ...
        var js = fs.readFileSync(pth.join(__dirname, "client/couth-resource-api.tmpl.js"), "utf8")
                   .replace('["REPLACE ME"]', JSON.stringify(allTypes, null, 4));
        this.addStatics([
            {
                path:       "/couth/js/couth-resource-api.js"
            ,   content:    new Buffer(js)
            ,   type:       "text/javascript"
            }
        ,   {
                path:       "/couth/js/couth-client.js"
            ,   content:    pth.join(__dirname, "client/couth-client.js")
            ,   type:       "text/javascript"
            }
        ,   {
        ...
        ,   {
                path:       "/couth/css/jquery-ui-1.10.1.custom.min.css"
            ,   content:    pth.join(__dirname, "../vendor/jquery-ui-1.10.1.custom.min.css")
            ,   type:       "text/css"
            }
        ,   {
                path:       "/couth/js/jquery-ui-1.10.1.custom.min.js"
            ,   content:    pth.join(__dirname, "../vendor/jquery-ui-1.10.1.custom.min.js")
            ,   type:       "text/javascript"
            }
        ,   {
                path:       "/couth/js/jquery.min.js"
            ,   content:    pth.join(__dirname, "../vendor/jquery.min.js")
            ,   type:       "text/javascript"
            }
        ,   {
                path:       "/couth/js/angular.min.js"
            ,   content:    pth.join(__dirname, "../vendor/angular.min.js")
            ,   type:       "text/javascript"
            }
        ]);
    }
