...
exports.updateFor = function (doc, req) {
    ...
    return [obj, { headers: { "Content-Type": "application/json" }, body: { ok: true } }];
};
...
exports.deleteFor = function (doc) {
    if (!doc) return [null, { headers: { "Content-Type": "application/json"}, body: { ok: false, errors: ["Not found."] } }];
    doc._deleted = true;
    return [doc, { headers: { "Content-Type": "application/json" }, body: { ok: true } }];
};
